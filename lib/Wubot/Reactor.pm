...
Wubot::Reactor is the 'reactive' part of the wubot project.  Given a
message that was generated by a monitor, the reactor walks through a
rule tree, and executes any rules whose conditions evaluate to true
for the message.
...
For more information, see L<Wubot::Guide::Rules>.
